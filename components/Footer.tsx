  ...
  return (
    ...
    <div className="justify-between max-w-screen-lg px-4 py-10 mx-auto text-gray-800 sm:px-6 sm:flex">
        <div className="p-5 border-r sm:w-2/12">
            <div className="text-sm font-bold text-indigo-600 uppercase">Menu</div>
            <ul>
                <li className="my-2">
        ...
        <div className="p-5 text-center border-r sm:w-7/12">
            <h3 className="mb-4 text-xl font-bold text-indigo-600">Componentity</h3>
            <p className="mb-10 text-sm text-gray-500">Lorem Ipsum is simply dummy text of the printing and typesetting
    ...
    <div className="flex flex-col items-center max-w-screen-xl py-5 m-auto text-sm text-gray-800 border-t">
        {/* <div className="flex flex-row mt-2 md:flex-auto md:flex-row-reverse">
            <a href="#" className="w-6 mx-1">
                <svg className="text-gray-500 cursor-pointer fill-current hover:text-indigo-600" width="100%" height="100%"
