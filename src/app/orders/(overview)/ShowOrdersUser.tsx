...
import { formatPrice, searchParamsCache } from "@/lib/utils";
    ...
    <div className="grid grid-cols-1 auto-rows-max gap-8">
      <div className="grid grid-cols-1 gap-4 sm:hidden">
        {orders.map((order, _) => (
          <Card
            key={order.id}
            className="grid grid-col-1 gap-2 text-muted-foreground"
          >
            ...
            <div className="grid gap-3 px-8  py-4 sm:text-blue-500">
              <div className="flex">
                <div className="mr-auto text-blue-500 font-semibold">
                  Order Date
                </div>
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className=" text-muted-foreground ">
        ...
        >
          <Link href={`/orders/${orderId}/orderdetail`}>
            {" "}
            <ListOrderedIcon className="size-5" />
            see order details
          </Link>
