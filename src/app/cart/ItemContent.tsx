...
const ItemContent = ({ item }: { item: CartProductType }) => {
  ...
  return (
    ...
    >
      <div
        onClick={() => router.push(`/${item.id}/product`)}
        className="hover:cursor-pointer max-sm:h-32 col-span-2 sm:col-span-1 flex justify-center items-center"
      >
        <Image
      ...
      <div className="grid gap-2 col-span-2 sm:col-span-1">
        <div>
          <h1 className="max-sm:text-center text-wrap text-blue-500">
            {item.name}
          </h1>
      ...
      <div className=" col-span-2 sm:col-span-1">
        <div className=" flex items-center gap-2 max-sm:justify-center">
          ...
          >
            <LucideTrash2 className="group-hover:text-blue-500" size={20} />
